 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 80 //40        // Seconds // FW
  #define THERMAL_PROTECTION_HYSTERESIS 15 //4     // Degrees Celsius // FW
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD  120 //40               // Seconds // FW
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        80 //20 // Seconds // FW
  #define THERMAL_PROTECTION_BED_HYSTERESIS     15 //2 // Degrees Celsius // FW

  /**
   * As described above, except for the bed (M140/M190/M303).
   */
  #define WATCH_BED_TEMP_PERIOD                80 //60 // Seconds // FW
 ...
 */
#define INPUT_SHAPING_X // FW
#define INPUT_SHAPING_Y // FW
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define USB_FLASH_DRIVE_SUPPORT // FW
...
#define BABYSTEPPING // FW
  ...
  #define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps // FW
  #define BABYSTEP_MULTIPLICATOR_Z  0.05 //1       // (steps or mm) Steps or millimeter distance for each Z babystep // FW
...
#define LIN_ADVANCE // FW
  ...
  #define EXPERIMENTAL_SCURVE   // Allow S-Curve Acceleration to be used with LA. // FW
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       1000 //800        // (mA) RMS current. Multiply by 1.414 for peak current. // FW
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V //12V        // All axes (override below) // FW
